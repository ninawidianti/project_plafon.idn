...
const Homepage = () => {
    ...
    switch (selectedFilter) {
      ...
      default:
        return (
          ...
          (cafe.alamat && cafe.alamat.toLowerCase().includes(term)) ||
          cafe.rating.toString().includes(term)
        );
    }
  });
  ...
  // Fungsi bantu untuk parsing foto_cafe yang bisa berupa string atau JSON array string
  const parseFotoCafe = (fotoCafeRaw) => {
    ...
    <div className="homepage-container">
      ...
      <div className="overlay">
        ...
        <main className="main-content">
          <h1 className="title">
            Temukan Rekomendasi Cafe Terbaik di Padang
          </h1>
          ...
          <div className="search-section" ref={dropdownRef}>
            <input
              ...
              placeholder="Cari Rekomendasi Cafe"
              value={searchTerm}
      ...
      <section className="recommendation-section">
        ...
        <p className="section-header">
          Cafe-cafe kece yang kita highlight, karena mereka tahu caranya bikin
          nongki makin asik!
        </p>
        <div className="card-container">
          {(searchTerm ? filteredCafes : filteredCafes.slice(0, 4)).map(
            (cafe) => {
              const fotoArray = parseFotoCafe(cafe.foto_cafe);
              const fotoUtama = fotoArray.length > 0 ? fotoArray[0] : "default.jpg";
              return (
                <div
                  className="cafe-card"
                  key={cafe.id}
                ...
                >
                  <img
                    src={`http://localhost:5000/uploads/${fotoUtama}`}
                    alt={cafe.name}
      ...
      <section className="tentang-container">
        ...
        <div className="text-section">
          ...
          <p className="isi">
            Plafon.idn adalah platform rekomendasi cafe di Padang. Kami
            menyediakan informasi tentang berbagai cafe terbaik yang ada di Kota
            Padang, mulai dari suasana, menu, hingga fasilitas yang disediakan.
          </p>
          <p className="isi">
            Plafon.idn hadir untuk membantu kamu menemukan tempat nongkrong yang
            sesuai dengan suasana hati dan kebutuhanmu—mulai dari cafe estetik
            untuk foto-foto, tempat nyaman buat nugas, hingga cafe dengan menu
            lengkap untuk makan berat.
          </p>
          <p className="isi">
            Temukan cafe favoritmu, jelajahi sudut kota Padang dengan lebih seru
            bersama Plafon.idn!
          </p>
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(to bottom, #1BFCB680, #A2BDB580)", // Gradasi dari atas ke bawah
      ...
      >
        <div className="bintang-content">
          ...
          >
            ...
            >
              Nikmati pengalaman nongkrong terbaik dari café-café pilihan dengan
              rating sempurna di Kota Padang. Setiap sudutnya menyimpan rasa,
              suasana, dan pelayanan yang diakui langsung oleh para pengunjung.
            </p>
          </div>

          <div className="bintang-right">
            {cafes
              .filter((cafe) => Number(cafe.rating) === 5)
              .map((cafe) => {
                const fotoArray = parseFotoCafe(cafe.foto_cafe);
                const fotoUtama = fotoArray.length > 0 ? fotoArray[0] : "default.jpg";
                return (
      ...
      <section className="recommendation-section">
        ...
        <div className="card-container">
          {cafes
            .filter((cafeItem) => cafeItem.kategori === "cafe")
            .slice(0, 4)
            .map((cafe) => {
              const fotoArray = parseFotoCafe(cafe.foto_cafe);
              const fotoUtama = fotoArray.length > 0 ? fotoArray[0] : "default.jpg";
      ...
      <section className="recommendation-section">
        ...
        <div className="card-container">
          {cafes
            .filter((cafeItem) => cafeItem.kategori === "resto")
            .slice(0, 4)
            .map((cafe) => {
              const fotoArray = parseFotoCafe(cafe.foto_cafe);
              const fotoUtama = fotoArray.length > 0 ? fotoArray[0] : "default.jpg";
      ...
      >
        ...
        <div
          className="lokasi-right"
          style={{ flex: 1, minWidth: "300px", marginTop: "30px" }}
        >
